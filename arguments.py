...
def setup_parent():
    ...
    shared_arguments.add_argument('--tool_dirs', nargs='+', default = ['.'], help='tool directories to scan recursively.')
    ...
    shared_arguments.add_argument('--cores', type=int, default=1, help='Number of cores to use for parallelizing planemo.')
